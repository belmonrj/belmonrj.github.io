...
You may or may not be aware that, while Artificial Intelligence is a real discipline and a legitimate area of academic inquiry, what most people mean when they say "AI" is stuff like ChatGPT, Claude, Copilot, etc---that is, chat bots that are powered by large language models (LLMs).  An LLM is neither artificial nor intelligent.  All it does is assemble words (or more precisely "tokens") in a certain order based on probability.  The probabilities are determined by "training" the model on "real data" which almost universally involves [dramatic](https://www.cnn.com/2023/07/11/tech/google-ai-lawsuit), [large-scale](https://www.theatlantic.com/technology/archive/2025/03/libgen-meta-openai/682093/) [theft](https://news.bloomberglaw.com/ip-law/openais-legal-woes-driven-by-unclear-mesh-of-web-scraping-laws) of [people's work]().  Books, articles, encyclopedia entries, websites, social media posts, etc.  All of those things taken without the consent of the authors.  Indeed, this "AI" is [absolutely not possible](https://www.forbes.com/councils/forbestechcouncil/2025/01/09/powering-llms-four-considerations-when-building-a-data-infrastructure/) without mass theft.

The use of "AI" does a lot of things to you, all of them bad.  It leads to various forms of [cognitive decline](https://pmc.ncbi.nlm.nih.gov/articles/PMC11020077/), including [memory loss](https://publichealthpolicyjournal.com/mit-study-finds-artificial-intelligence-use-reprograms-the-brain-leading-to-cognitive-decline/),  [cognitive offloading](https://www.computer.org/publications/tech-news/trends/cognitive-offloading), and [cognitive surrender](https://arstechnica.com/ai/2026/04/research-finds-ai-users-scarily-willing-to-surrender-their-cognition-to-llms/).  Depending on your age, [it takes away skills you used to have and/or prevents you from developing new ones](https://www.psychologytoday.com/us/blog/the-algorithmic-mind/202603/adults-lose-skills-to-ai-children-never-build-them).  In rare cases it leads to AI psychosis---here are two general summaries (content warning for both) [Psychology Today](https://www.psychologytoday.com/us/blog/urban-survival/202507/the-emerging-problem-of-ai-psychosis), [Psychiatry Online](https://psychiatryonline.org/doi/10.1176/appi.pn.2025.10.10.5).
...
Let's now take a moment and think about others and the world around us.  The data centers needed to run LLMs are causing [vast](https://www.cnn.com/2026/03/30/climate/data-centers-are-having-an-underrported) [amounts](https://www.cbsnews.com/chicago/news/data-centers-for-ai-electricity-water-climate-health/) of [environmental](https://apnews.com/article/ai-data-center-climate-impact-environment-c6218681ffdbad5bf427b47347fddcb9) [destruction](https://www.businessinsider.com/ai-data-center-cost-2025-6).  For the people unfortunate enough to live near them, there's a wide range of additional harmful effects, such as [increased electricity bills](https://www.cnbc.com/2025/11/26/ai-data-center-frenzy-is-pushing-up-your-electric-bill-heres-why.html), [noise pollution](https://www.nj.com/news/2026/03/this-mysterious-humming-is-driving-nj-town-crazy-as-a-massive-ai-data-center-rises.html), and [excessive heat](https://fortune.com/2026/04/01/ai-data-centers-heat-island-hyperscalers/).  When we use "AI" chatbots for any purpose, we are implicitly accepting these data centers and all the environmental and social harms they cause.

This next one is a little more indirect, but also very grave.  Any computing system, LLM or otherwise, is only as good as the data you give it---garbage in, garbage out.  The over-reliance on "AI" and the cognitive surrender that engenders make it more likely that people will fail to update model data.  That leads to, for example, an LLM-powered military targeting system telling pilots to drop bombs on a [school](https://www.militarytimes.com/news/your-military/2026/03/24/deadly-iran-school-strike-casts-shadow-over-pentagons-ai-targeting-push/) full of [little](https://www.theguardian.com/news/2026/mar/26/ai-got-the-blame-for-the-iran-school-bombing-the-truth-is-far-more-worrying) [girls](https://www.independent.co.uk/news/world/americas/us-politics/iran-school-attack-ai-investigation-b2937456.html).  When we use "AI" chatbots for any purpose, we are implicitly accepting their use in military operations and, therefore, any "collateral damage" that comes along with that usage.
