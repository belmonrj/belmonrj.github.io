...
{% for var in site.data.publications.short %}
   ...
   {%- assign print_me = '- ' | append: print_title | append: ' <br> ' | append: print_published | append: ' <br> ' | append: print_doi | append: ', ' | append: print_arxiv | append: ', ' | append: print_inspire | append: ' <br><br> ' %}
   {{ print_me }}
{%- endfor -%}
{{ nil }}
